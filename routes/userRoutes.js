...
const {getUser,registerUser,loginUser,getIp,isLoggedIn,DeleteAllUsers,updateProfilePic,information,emailChange,passwordChange,deleteAccount}=require('../Controllers/userControllers')
const {postHomes,DeleteOneHome,getHomes,updateHome,getUserHomes,getAllHomes,postSimilarProp}=require('../Controllers/postHomeControllers')
...
const {postEmail}=require('../Controllers/EmailListController')
const multer=require('multer')
var path = require('path')

const storage=multer.diskStorage({
    destination:function (req,file,cb){
        cb(null,'./public/deleteFolder/')
    },
...
router.post('/deleteaccount',authProtect, deleteAccount)
router.delete('/login/:id', DeleteAllUsers)

router.post('/subEmail', postEmail)
...
router.post('/property/getalllisting', getAllHomes)
router.post('/property/postsimilarprop', postSimilarProp)
